---
name: spec-gen-java-sqlserver
description: Generates detailed design specs (詳細仕様書) for Java × SQL Server systems — Spring Boot applications deployed in Microsoft Azure or on-premises Windows Server environments. Use when documenting Spring Boot × SQL Server applications using MyBatis or Spring Data JPA with Microsoft JDBC driver, generating specs for Java batch jobs accessing SQL Server, or creating 詳細仕様書 for Java microservices with Azure SQL Database. Covers T-SQL specifics (TOP/OFFSET-FETCH, MERGE, IDENTITY), jTDS vs Microsoft JDBC driver, Windows Authentication, and Azure AD integration. Extends spec-gen-enterprise-ja.
---
