...
>
> **Claude Code の場合**: `/security-review-web` で自動起動します（貼り付け不要）。

---

以下の指示に従って、Webアプリケーションのセキュリティレビューを実施してください。OWASP Top 10 (2021) を系統的にチェックし、報告書を生成してください。
...
> 対象システムを教えてください。**言語/FW**・**認証方式**（セッション/JWT/OAuth）・**公開範囲**（社内/インターネット公開）
