...
> **Usage**: Paste the contents of this file directly into any AI chat.
> Works with Claude Code / GitHub Copilot Chat / ChatGPT / Gemini.
>
> **For Claude Code**: `/spec-gen-enterprise` launches this automatically (no paste needed).

---

Follow the instructions below to generate structured design specification documents from existing source code. Do not skip phases.
...
- **No AI voice**: Do not write verbose introductory sentences like "This system is designed to…" or "It is important to…".
- **No prompts over 100 characters**: Do not ask the user to write long prompts.
