---
name: spec-gen-java-oracle
description: Generates detailed design specs (詳細仕様書) for Java × Oracle systems — the most common Japanese enterprise stack. Use when documenting Spring Boot × Oracle applications, generating specs from MyBatis mapper XML files, documenting ROWNUM/ROW_NUMBER() pagination patterns, or creating 詳細仕様書 for Java SE batch jobs using JDBC. Covers Spring Boot 2/3, MyBatis 3, Spring Data JPA, Hibernate, Oracle 11g/19c, and JDBC direct access. Extends spec-gen-enterprise-ja with Oracle-specific SQL patterns.
---
